          ...
          <View style={styles.containerView}>
            <View style={styles.topView}>
              ...
              <View style={{ top: -30, marginHorizontal: 20 }}>
                ...
                >
                  {isVerifcationPopUp
                    ? "You have recently checked in through office face verifcaion POS. Please verfiy your face"
                    : "if you are going from the site you can assign your task to any person present in your team."}
                </Text>
                {/* {isVerifcationPopUp ? null : <Text style={styles.modalText3}>Please select your team member whom you assign the task</Text>} */}
                ...
                {/* {isVerifcationPopUp ? null :
                  <DropDownPicker
                    ...
                    dropDownInputContainer={[styles.dropDownInputContainer, { backgroundColor: 'lightgrey' }]}
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.cancelButton}>
                    {/* {isVerifcationPopUp ? 'Cancel':'END OF WORK'} */}
                    Check Out
                  </Text>
                  {/* </LinearGradient> */}
                </TouchableOpacity>
